...
public class AltDbo {
    ...
    public String quote(String s){
        return s == null ? "" : (this.sequence_name != null && s.contains(this.sequence_name) ? s : "'" + s.replaceAll("= ", "") + "'");
    }
    ...
    public AltDbRow retrieve(Map<String, String> data) throws AltException {
        ...
        if(params.get(this.pkey) != null)
            params.put(this.pkey, "= " + params.get(this.pkey));

        AltDbRows res = this.get(params);
    ...
    public int insert(Map<String, String> data) throws AltException {
        ...
        if (table_fields.get("entrytime") != null && data.get("entrytime") == null)
            data.putIfAbsent("entrytime", String.valueOf(Instant.now().getEpochSecond()));
        if (table_fields.get("createdate") != null && data.get("createdate") == null)
            data.putIfAbsent("createdate", String.valueOf(Instant.now().getEpochSecond()));

        if(this.request != null) {
            Map<String, String> userdata = Alt.get_userdata(this.request);
            if (table_fields.get("entryuser") != null && data.get("entryuser") == null)
                data.putIfAbsent("entryuser", userdata.get("username"));
            if (table_fields.get("createuser") != null && data.get("createuser") == null)
                data.putIfAbsent("createuser", userdata.get("username"));
        }
    ...
    public int update(Map<String, String> data) throws AltException {
        ...
        if (table_fields.get("modifiedtime") != null && data.get("modifiedtime") == null)
            data.putIfAbsent("modifiedtime", String.valueOf(Instant.now().getEpochSecond()));
        if (table_fields.get("moddate") != null && data.get("moddate") == null)
            data.putIfAbsent("moddate", String.valueOf(Instant.now().getEpochSecond()));
        if(this.request != null) {
            Map<String, String> userdata = Alt.get_userdata(this.request);
            if (table_fields.get("modifieduser") != null && data.get("modifieduser") == null)
                data.putIfAbsent("modifieduser", userdata.get("username"));
            if (table_fields.get("moduser") != null && data.get("moduser") == null)
                data.putIfAbsent("moduser", userdata.get("username"));
        }
    ...
    public int delete(Map<String, String> data) throws AltException {
        ...
        if(fields.get("isdeleted") != null){
            if (fields.get("deletedtime") != null && data.get("deletedtime") == null)
                data.putIfAbsent("deletedtime", String.valueOf(Instant.now().getEpochSecond()));
            if (fields.get("isdeleted") != null)
                data.putIfAbsent("isdeleted", "1");

            if(this.request != null) {
                Map<String, String> userdata = Alt.get_userdata(this.request);
                if (fields.get("deleteduser") != null && data.get("deleteduser") == null)
                    data.putIfAbsent("deleteduser", userdata.get("username"));
            }
